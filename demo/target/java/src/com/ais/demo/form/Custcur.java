...
public  class Custcur extends Form{
  ...
  private void jbInit() throws Exception{
    ...
    this.setName("custcur");
    GridBagLayout thislayout = new GridBagLayout();
    this.setLayout(thislayout);
    this.setSize(GridBagLayoutHelper.computeSize(thislayout, this, 62, 9));
    //*** Component Initialization ***
    label_0.setName("label_0");
    label_0.setText("CUSTOMER FORM");
    this.add(label_0, new GridBagConstraints(24, 0, 13, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    label_1.setName("label_1");
    label_1.setText("Number:");
    this.add(label_1, new GridBagConstraints(4, 2, 7, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    this.add(customer__customer_num, new GridBagConstraints(14, 2, 11, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    label_2.setName("label_2");
    label_2.setText("First Name:");
    this.add(label_2, new GridBagConstraints(0, 3, 11, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    this.add(customer__fname, new GridBagConstraints(14, 3, 15, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    label_3.setName("label_3");
    label_3.setText("Last Name:");
    this.add(label_3, new GridBagConstraints(33, 3, 10, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    this.add(customer__lname, new GridBagConstraints(46, 3, 15, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    label_4.setName("label_4");
    label_4.setText("Company:");
    this.add(label_4, new GridBagConstraints(3, 4, 8, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    this.add(customer__company, new GridBagConstraints(14, 4, 20, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    label_5.setName("label_5");
    label_5.setText("Address:");
    this.add(label_5, new GridBagConstraints(3, 5, 8, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    this.add(customer__address1, new GridBagConstraints(14, 5, 20, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    this.add(customer__address2, new GridBagConstraints(37, 5, 20, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    label_6.setName("label_6");
    label_6.setText("City:");
    this.add(label_6, new GridBagConstraints(6, 6, 5, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    this.add(customer__city, new GridBagConstraints(14, 6, 15, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    label_7.setName("label_7");
    label_7.setText("State:");
    this.add(label_7, new GridBagConstraints(33, 6, 6, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    this.add(customer__state, new GridBagConstraints(42, 6, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    label_8.setName("label_8");
    label_8.setText("Zip:");
    this.add(label_8, new GridBagConstraints(49, 6, 4, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    this.add(customer__zipcode, new GridBagConstraints(56, 6, 5, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    label_9.setName("label_9");
    label_9.setText("Phone:");
    this.add(label_9, new GridBagConstraints(5, 7, 6, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    this.add(customer__phone, new GridBagConstraints(14, 7, 18, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
