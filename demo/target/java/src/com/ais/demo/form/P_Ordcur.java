...
public  class P_Ordcur extends Form{
  ...
  TextBox formonly__t_price = new TextBox();
  ...
  private void jbInit() throws Exception{
    ...
    label_4.setText("Total Price:");
    this.add(label_4, new GridBagConstraints(32, 3, 12, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    formonly__t_price.setName("t_price");
    formonly__t_price.setType(new Money(16, 2));
    formonly__t_price.setNotNull(false);
    formonly__t_price.setEnabled(false);
    formonly__t_price.setLength(10);
    this.add(formonly__t_price, new GridBagConstraints(46, 3, 10, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    label_5.setName("label_5");
    label_5.setText("Instructions:");
    this.add(label_5, new GridBagConstraints(0, 4, 13, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    label_6.setText("Backlog:");
    this.add(label_6, new GridBagConstraints(5, 5, 8, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    label_7.setText("PO Number:");
    this.add(label_7, new GridBagConstraints(33, 5, 10, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    label_8.setText("Ship Date:");
    this.add(label_8, new GridBagConstraints(3, 6, 10, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    label_9.setText("Ship Weight:");
    this.add(label_9, new GridBagConstraints(31, 6, 12, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    label_10.setText("Ship Charge:");
    this.add(label_10, new GridBagConstraints(1, 7, 12, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    label_11.setText("Date Paid:");
    this.add(label_11, new GridBagConstraints(33, 7, 10, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    ...
    formonly.setFields(formonly__t_price);
